...
start_arb_char_input:                   ;Start user input loop
    call    read_char
    cmp     al, 00Ah                    ;Check if input is newline
    je      newline_input_two
...
finish_read_char_two:

newline_input_two:
    cmp     al, 00Ah                    ;Check if input is newline
    jne     start_arb_char_input
